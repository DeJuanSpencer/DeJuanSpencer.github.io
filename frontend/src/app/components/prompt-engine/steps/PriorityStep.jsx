...
export function PriorityStep({ loading, priorities, dragIdx, dragOverIdx, itemLoading, generatePriorities, regeneratePriority, handleDragStart, handleDragOver, handleDragEnd, movePriority }) {
  return (
